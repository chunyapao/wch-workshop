...
📌 ค่า config ที่สำคัญ:
  • max_tokens=768 (แต่ละเส้นทาง) → จำกัดคำตอบแต่ละเส้นทาง 768 Token
  • max_tokens=768 (ประเมิน) → จำกัดคำตอบตอนประเมิน 768 Token
...
print("=" * 60)
print("Tree of Thoughts - บุญส่ง ศรีทอง เคยทำงานที่ไหน?")
print("=" * 60)
...
- บุญส่ง ศรีทอง เรียนจบปีไหน?
- หลังเรียนจบ เริ่มทำงานเลยหรือไม่?
- ถ้าเริ่มทำงานเลย ปีที่เริ่มทำงานคือปีไหน?
...
เส้นทางที่ 2: วิเคราะห์จากประวัติการทำงาน
- บุญส่ง ศรีทอง มีประวัติการทำงานอย่างไร?
- งานแรกคืองานอะไร?
- เริ่มทำงานแรกปีไหน?
...
print("\n" + "=" * 60)
print("เส้นทางที่ 2: วิเคราะห์จากประวัติการทำงาน")
print("=" * 60)
...
- บุญส่ง ศรีทอง เกิดปีไหน?
- อายุเท่าไหร่เมื่อเริ่มทำงาน?
- ช่วงเวลานั้นมีเหตุการณ์อะไรที่เกี่ยวข้อง?
- สรุปปีที่เริ่มทำงานคือปีไหน?
...
evaluation_prompt = f"""
ฉันมี 3 เส้นทางความคิดเกี่ยวกับคำถาม: "บุญส่ง ศรีทอง เคยทำงานที่ไหน?"
...
3. คำตอบสุดท้ายที่ได้จากเส้นทางนั้นคือปีอะไร?
...
final_prompt = f"""
จากการวิเคราะห์ 3 เส้นทางเกี่ยวกับคำถาม: "บุญส่ง ศรีทอง เคยทำงานที่ไหน?"
...
Tree of Thoughts Structure:
         ...
         การศึกษา       ประวัติการทำงาน   บริบทแวดล้อม
              |               |               |
              └───────────────┼───────────────┘
                              |
                        [ประเมิน]
