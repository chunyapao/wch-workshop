...
def initialize_model():
    ...
    lora_config = {
        "rank": 8,       # ขนาด Matrix: ต้องตรงกับ LORA_RANK ใน .env
        "scale": 2.0,    # อิทธิพลของ LoRA: 2.0 = LoRA มีน้ำหนัก 2 เท่า
        "dropout": 0.1   # ป้องกัน overfit: 10% = ตัด neuron ทิ้ง 10% ตอนเทรน
    }
